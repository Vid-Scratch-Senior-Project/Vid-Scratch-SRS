...
\def \srsTitle{Vid-Scratch \\[0.5cm] (Project Proposal)}
\def \srsAuthorOne{Nantawan Paramapooti}
\def \srsAuthorTwo{Pichayoot Tanasinanan}
\def \srsAcademicYear{2026}

\def \srsAdvisorName{Punpiti Piamsa-nga}
\def \srsCoAdvisorName{Prof. Chantana Chantrapornchai}
\def \srsHoDName{Punpiti Piamsa-nga}
%% -----------------------------------
